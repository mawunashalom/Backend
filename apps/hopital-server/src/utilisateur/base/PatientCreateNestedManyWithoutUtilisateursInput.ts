...
@InputType()
class PatientCreateNestedManyWithoutUtilisateursInput {
...
export { PatientCreateNestedManyWithoutUtilisateursInput as PatientCreateNestedManyWithoutUtilisateursInput };
