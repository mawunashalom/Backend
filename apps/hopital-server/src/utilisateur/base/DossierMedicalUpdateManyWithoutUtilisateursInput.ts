...
@InputType()
class DossierMedicalUpdateManyWithoutUtilisateursInput {
...
export { DossierMedicalUpdateManyWithoutUtilisateursInput as DossierMedicalUpdateManyWithoutUtilisateursInput };
